...
class LYBConstant():
    ...
    LYB_GAME_PENGUINSISLE = '펭귄의섬'
    LYB_GAME_DATA_PENGUINSISLE = 'penguinsisle'

    LYB_GAMES = {
        LYB_GAME_PENGUINSISLE: LYB_GAME_DATA_PENGUINSISLE,
    }
    ...
    LYB_DO_PREFIX = 'do_'
    LYB_PENGUINSISLE_PREFIX = 'penguinsisle_'
    ...
    LYB_DO_STRING_PENGUINSISLE_WORK = LYB_DO_PREFIX + LYB_PENGUINSISLE_PREFIX + 'work_'
    LYB_DO_STRING_PENGUINSISLE_NOTIFY = LYB_DO_PREFIX + LYB_PENGUINSISLE_PREFIX + 'notify_'
    LYB_DO_STRING_PENGUINSISLE_ETC = LYB_DO_PREFIX + LYB_PENGUINSISLE_PREFIX + 'etc_'
