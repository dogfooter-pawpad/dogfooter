...
class LYBMakeResource():
    ...
    def mouseMove(self, str, x, y):
        dll, mov, btn, op_cnt = likeyoubot_dd.DDClass.get_dll()
    ...
    def execute(self):
        ...
        try:
            ...
            self.resource_manager = lybresource.LYBResourceManager(lybresource.LYBPixelBoxDic(),
                                                                   lybresource.LYBResourceDic())
        ...
        while True:
            ...
            if e != 0:
                ...
                if self.current_grab_window == None or self.epb == None:
                    ...
                    self.epb = lybresource.LYBExtractPixelBox(self.anchor_x, self.anchor_y,
            ...
            # is_done = True
                ...
                for each_pixel_box_name in self.resource_manager.resource_dic[resource_name]:
                    ...
                    self.mouseMove(each_pixel_box_name, each_pixel_box[0][0][0] + self.anchor_x,
